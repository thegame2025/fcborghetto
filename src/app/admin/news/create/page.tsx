...
export default function CreateNewsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error('Errore durante la creazione della news');
      }
      ...
      toast.error('Errore durante la creazione della news');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold">Crea News</h1>
        <Link 
          href="/admin/news"
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end">
            ...
            >
              ...
              {isLoading ? 'Salvataggio...' : 'Salva News'}
            </button>
          </div>
        </form>
      </div>
